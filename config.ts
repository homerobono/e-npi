export const Globals = Object.freeze({
	...
	NPI_PIXEL_CRITICAL_DEPTS: ['MPR', 'PRO', 'OPR', 'ADM', 'COM'],
	NPI_INTERNAL_CRITICAL_DEPTS: ['PRO', 'OPR', 'ADM', 'COM'],
	NPI_CUSTOM_CRITICAL_DEPTS: ['PRO', 'OPR', 'ADM', 'COM'],
	NPI_OEM_CRITICAL_DEPTS: ['PRO', 'OPR', 'ADM', 'COM'],

	OEM_ACTIVITIES: [
		{ value: 'DOCS', label: 'Solicitação de Documentos (BOM, Gerbers, etc)', dep: [], dept: 'COM', term: 4, annex: true, required: true },
	...
	LABELS: {
		...
		regulations: 'Homologações/Regulamentações',
		demand: 'Demanda',
	...
	ACTIVITIES_DEPTS: ['MPD', 'OSC', 'MPR', 'PRO', 'COM', 'OPR'],
